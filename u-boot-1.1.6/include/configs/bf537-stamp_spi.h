...
#if ((BFIN_BOOT_MODE == BF537_BYPASS_BOOT) || (BFIN_BOOT_MODE == BF537_UART_BOOT) ||(BFIN_BOOT_MODE == BF537_SPI_MASTER_BOOT) )
...
#define CONFIG_EXTRA_ENV_SETTINGS                               \
	"go=tftp 2000000 linux; bootelf 2000000\0" \        
	"ramargs=setenv bootargs root=/dev/mtdblock0 rw console=ttyBF0,57600\0"      \
        ...
        "bootdhcp=dhcp;set serverip 172.24.254.207; run go;"\
	""
#else
#define CONFIG_EXTRA_ENV_SETTINGS                               \
        "ramargs=setenv bootargs root=/dev/mtdblock0 rw console=ttyBF0,57600\0" \
...
#elif (BFIN_BOOT_MODE == BF537_SPI_MASTER_BOOT)
#define CFG_ENV_SIZE            0x2000    /* provisory */
#define CFG_ENV_ADDR            0x20004000
